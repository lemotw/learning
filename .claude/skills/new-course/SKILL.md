...
4. **給使用者看,等回饋修改**。確認後固化:`courses/<slug>/DIAGNOSTIC.md`、`AGENDA.md`、`meta.json`(照 `pipeline/templates/`;slug 用英文 kebab-case),並建 `units/` 佔位檔(只有 `# Unit N:標題` 一行)、`labs/`。
